...
REPO_URL = 'https://github.com/daemonLXH/superlists.git'

def deploy():
    site_folder = '/data/sites/%s' % (env.host,)
...
def _create_directory_structure_if_necessary(site_folder):
    for fubfolder in ('database','static','virtualenv','source'):
        run('mkdir -p %s/%s' % (site_folder,fubfolder,))
